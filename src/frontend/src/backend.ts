...
export class Backend implements backendInterface {
    ...
    async checkIn(arg0: number, arg1: number): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAlertHistory(): Promise<Array<Alert>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAlertHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLocationHistory(): Promise<Array<CheckIn>> {
        if (this.processError) {
            try {
    ...
    async sendSOS(arg0: number, arg1: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendSOS(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
